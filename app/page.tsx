...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Every course is designed to enhance your career prospects",
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">VidyaVaradhi</h1>
                <p className="text-sm text-slate-600">{"Empowering Indian Education"}</p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 text-balance leading-tight">
                  {"Empowering Minds for an "}
                  <span className="text-blue-600">AI-Driven Future</span>
                </h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {userTypes.map((userType) => {
                ...
                return (
                  <Card
                    key={userType.id}
                    className="group cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-105 border-2 hover:border-blue-300 bg-white/80"
                    onClick={() => handleUserTypeSelect(userType.id)}
                  >
                    <CardHeader className="text-center pb-4">
                      <div
                        className={`mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full ${userType.color} text-white shadow-lg`}
                      >
                    ...
                    <CardContent className="pt-0">
                      ...
                      <Button
                        className="w-full group-hover:bg-blue-600 group-hover:text-white transition-colors bg-transparent text-slate-700 border-slate-300"
                        variant="outline"
                      >
                        {"Get Started"}
